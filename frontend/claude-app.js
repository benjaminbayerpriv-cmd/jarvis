  ...
  function buildUi() {
    ...
    uiEl.innerHTML = `
      <div class="js-nav-row" style="position:absolute;top:14px;left:12px;z-index:31;display:flex;align-items:center;gap:2px;">
        <button class="js-side-toggle" title="Toggle sidebar" style="background:none;border:none;color:${C.textSoft};cursor:pointer;display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:8px;">${ICONS.menu}</button>
